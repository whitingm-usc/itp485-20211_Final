...
namespace Math
{
    bool IsCloseEnuf(const Vector3& a, const Vector3& b, float epsilon)
    {
        return IsCloseEnuf(a.x, b.x, epsilon)
            && IsCloseEnuf(a.y, b.y, epsilon)
            && IsCloseEnuf(a.z, b.z, epsilon);
    }
}
