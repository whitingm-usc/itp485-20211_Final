...
bool GetColorFromJSON(const rapidjson::Value& inObject, const char* inProperty, Graphics::Color4& outColor)
{
	auto itr = inObject.FindMember(inProperty);
	if (itr == inObject.MemberEnd())
	{
	...
	outColor.r = property[0].GetDouble();
	outColor.g = property[1].GetDouble();
	outColor.b = property[2].GetDouble();
	outColor.a = property[3].GetDouble();
